...
def bidak():
    ...
    glColor3f(0.6, 0.6, 0.6)  # Warna abu-abu lebih gelap untuk bayangan
    ...
    # bidang tengah
    glBegin(GL_POLYGON)
    glColor3f(0.8, 0.8, 0.8)  # Warna abu-abu muda untuk warna dasar
    ...
    # bidang tengah
    glBegin(GL_POLYGON)
    glColor3f(1.0, 1.0, 1.0)  # Warna putih untuk highlight
